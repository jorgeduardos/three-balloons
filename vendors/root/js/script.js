...
// gallery and team display
    ...
    // team member
     ...
     $('#member-open').click(function(){
        $('#member-info').addClass('animated fadeInRightBig').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
          $(this).removeClass('fadeInRightBig');
       });
    });


    $('#member-info .icon-container').click(function(){
       // $('#gallery').removeClass('animated fadeInRightBig');
       $('#member-info').addClass('animated fadeOutRightBig').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
          $(this).removeClass('animated fadeOutRightBig');
       });
